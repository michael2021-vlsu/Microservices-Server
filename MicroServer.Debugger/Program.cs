    ...
    class Program {
        ...
        static void Main(string[] args) {
...

            {
                ...
                do {
                    Console.WriteLine("Enter the GET url bellow (example: http://localhost:8080/5-semestr/compiler/get-job)");
                    Console.Write(">");
...

            {
                ...
                do {
                    Console.WriteLine("Enter the POST url bellow (example: http://localhost:8080/5-semestr/compiler/post-job)");
                    Console.Write(">");
